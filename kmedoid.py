...
# -*- coding: utf-8 -*-
"""
Created on Wed Oct  5 11:31:42 2022
...
def kmedoids_method(data):
    ...
    for i in range(5, round((len(data)**0.5))):
...
#Ex pour f0 = [-0.499261, -1.51369, -1.60321, ...]f0 = [f[0] for f in data]
...
k, score, labels, execution_time = kmedoids_method(data)
